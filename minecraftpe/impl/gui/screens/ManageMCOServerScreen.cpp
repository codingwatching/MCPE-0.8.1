...
void ManageMCOServerScreen::init(){
	...
	this->field_AC = new OptionButton(this->item.open);
	this->field_AC->setImageDef(v37, 1);
	//104, 1 are assigned here, no idea what they do -- maybe it is autogenerated by compiler(104 seems to be offset of Screen::onTextBoxUpdated in vt)
	...
	this->elements.push_back(this->field_AC);
	...
	this->elements.push_back(this->field_CC);
	this->elements.push_back(this->playerNameTextBox);
	this->elements.push_back(this->field_D8);
