...
struct FlintAndSteelItem: Item
{
	...
	virtual bool_t useOn(ItemInstance* a2, Player* a3, struct Level* a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, float a9, float a10, float a11) {
		int32_t v14; // r6
		int32_t v15; // r5
		int32_t v16; // r4
		float f; // r0
