...
struct ThinFenceTile : Tile{
	...
	ThinFenceTile(int32_t a2, const std::string& a3, const std::string& a4, const struct Material* a5, bool_t a6) :
			Tile(a2, a3, a5) {
		this->field_98 = a6;
	...
	virtual void updateShape(LevelSource* level, int32_t x, int32_t y, int32_t z) {
		...
		LABEL_29: this->setShape(v18, 0.0, v19, v17, 1.0, v20);
	}
	...
	virtual void addAABBs(Level* level, int32_t x, int32_t y, int32_t z, const AABB* a6, std::vector<AABB>& a7) {
		int32_t v11; // r0
		int32_t v12; // r0
		bool_t v13; // r11
		int32_t v14; // r0
		...
		a5 = 1.0;
		v18 = 0.5;
		LABEL_10: this->setShape(v18, 0.0, 0.4375, a5, 1.0, 0.5625);
		...
		LABEL_16: aaa = 1.0;
		LABEL_20: v22 = 0.0;
		LABEL_23: this->setShape(0.4375, 0.0, v22, 0.5625, 1.0, aaa);
		Tile::addAABBs(level, x, y, z, a6, a7);
	}
