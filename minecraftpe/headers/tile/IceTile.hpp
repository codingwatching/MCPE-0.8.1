...
struct IceTile : Tile{
	IceTile(int32_t id, const std::string& n, Material* m) :
			Tile(id, n, m) {
	...
	virtual void tick(Level* level, int32_t x, int32_t y, int32_t z, Random* r) {
		int32_t v11; // r0
	...
	virtual void playerDestroy(Level* level, Player* player, int32_t x, int32_t y, int32_t z, int32_t) {
		Material* v9; // r5
