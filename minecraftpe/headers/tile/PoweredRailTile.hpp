...
struct PoweredRailTile : BaseRailTile{
	...
	bool_t findPoweredRailSignal(Level*, int32_t, int32_t, int32_t, int32_t, bool_t, int32_t);
	bool_t isSameRailWithPower(Level*, int32_t, int32_t, int32_t, bool_t, int32_t, int32_t);
