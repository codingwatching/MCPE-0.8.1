...
struct AvailableGamesList: ScrolledSelectionList
{
	...
	AvailableGamesList(Minecraft* mc, int32_t w, int32_t h) :
			ScrolledSelectionList(mc, w, h, 24, w - 30, 28) {
	}
	...
	virtual void selectItem(int32_t a2, bool_t a3) {
		this->selectedItem = a2;
	}
	virtual bool_t isSelectedItem(int32_t a2) {
		return a2 == this->selectedItem;
	}
	virtual void renderItem(int32_t a2, int32_t a3, int32_t a4, int32_t a5, Tesselator& a6) {
